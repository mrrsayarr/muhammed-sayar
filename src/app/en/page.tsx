...
import { profileDataEn } from '@/data/profile-en'
    ...
    <main className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300 pt-20">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-section">
          <div className="md:w-1/2 text-center md:text-left mb-8 md:mb-0">
            ...
            <div className="flex justify-center md:justify-start space-x-4">
              ...
              <a
                href={profileDataEn.socialLinks.linkedin}
                target="_blank"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-section">
          {profileDataEn.skills.slice(0, 4).map((skill, index) => (
            <div
              key={index}
        ...
        <div className="flex justify-center space-x-8 mb-section">
          <a href={profileDataEn.socialLinks.linkedin}
             target="_blank" 
             rel="noopener noreferrer" 
          ...
          <a href={profileDataEn.socialLinks.instagram}
             target="_blank" 
             rel="noopener noreferrer" 
          ...
          <a href={profileDataEn.socialLinks.github}
             target="_blank" 
             rel="noopener noreferrer" 
        ...
        <section id="about" className="mb-section">
          <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
            <h3 className="text-3xl font-semibold mb-6 text-gray-800 dark:text-gray-200">About Me</h3>
        ...
        <section id="skills" className="mb-section">
          <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
            <h3 className="text-3xl font-semibold mb-8 text-gray-800 dark:text-gray-200">Skills</h3>
            <div className="space-y-4">
              {profileDataEn.skills.map((skill, index) => (
        ...
        <section id="experience" className="grid grid-cols-1 gap-section">
          {/* Work Experience */}
          <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
            <h3 className="text-3xl font-semibold mb-8 text-gray-800 dark:text-gray-200">Work Experience</h3>
            <div className="space-y-6">
              {profileDataEn.experience.map((exp, index) => (
          ...
          {/* Education */}
          <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
            <h3 className="text-3xl font-semibold mb-8 text-gray-800 dark:text-gray-200">Education</h3>
            <div className="space-y-6">
              {profileDataEn.education.map((edu, index) => (
        ...
        <footer className="mt-section pt-8 border-t border-gray-200 dark:border-gray-700">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Contact Info */}
            <div>
              <h4 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Contact</h4>
              <div className="space-y-4">
                <p className="text-gray-600 dark:text-gray-400">
                ...
                <div className="w-full h-32 rounded-lg overflow-hidden">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d385398.5897809314!2d28.731994799999998!3d41.0082376!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14caa7040068086b%3A0xe1ccfe98bc01b0d0!2zxLBzdGFuYnVs!5e0!3m2!1sen!2str!4v1710164548621!5m2!1sen!2str"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
            ...
            {/* Quick Links */}
            <div>
              <h4 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Quick Links</h4>
              <div className="space-y-2">
                <Link href="/en#about" className="block text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
                  About
                </Link>
                <Link href="/en#skills" className="block text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
                  Skills
                </Link>
                <Link href="/en#experience" className="block text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
                  Experience
                </Link>
              </div>
            </div>
            ...
            {/* Social Links */}
            <div>
              <h4 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Social Media</h4>
              <div className="flex space-x-4">
                <a href={profileDataEn.socialLinks.linkedin} target="_blank" rel="noopener noreferrer" 
                   className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
                  <FaLinkedin className="text-2xl" />
                </a>
                <a href={profileDataEn.socialLinks.github} target="_blank" rel="noopener noreferrer"
                   className="text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200">
                  <FaGithub className="text-2xl" />
                </a>
                <a href={profileDataEn.socialLinks.instagram} target="_blank" rel="noopener noreferrer"
          ...
          <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700 text-center text-gray-600 dark:text-gray-400">
            <p>© {new Date().getFullYear()} {profileDataEn.name}. All rights reserved.</p>
          </div>
        </footer>
      </div>
    </main>
